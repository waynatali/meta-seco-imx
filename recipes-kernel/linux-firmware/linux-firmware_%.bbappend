...
SRC_URI:append:seco-imx8mm-c61 = " \
...
do_install:append:seco-imx8mm-c61() {
...
FILES:${PN}-bcm43455:append:seco-imx8mm-c61 = " \
...
"
RDEPENDS:${PN}-bcm43455:remove:seco-imx8mm-c61 = " ${PN}-cypress-license "
